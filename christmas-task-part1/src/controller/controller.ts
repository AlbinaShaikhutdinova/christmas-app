...
export class Controller {
    ...
    constructor(data: Toy[]) {
        ...
        this.view = new View();
        const promise = new Promise<Toy[]>((resolve) => {
        ...
        this.view.toysView.chooseToyEvent.addListener((id) => {
            this.model.addToChosen(id);
        });
        ...
        this.model.updateChosenToysEvent.addListener((itemId) =>
            this.view.updateChosenItemsView(itemId, this.model.chosenToysList)
        );
    }
}
