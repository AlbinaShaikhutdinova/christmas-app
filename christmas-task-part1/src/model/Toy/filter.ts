...
export class FilterBlockBuilder {
    ...
    initValuesFilter(): FilterBlock {
        ...
        filterAttributes.push({
            name: 'Форма',
            attribute: 'shape',
            filterType: filterBy.enumVal,
            options: Object.keys(toyShape),
        });
        filterAttributes.push({
            name: 'Цвет',
            attribute: 'color',
            filterType: filterBy.enumVal,
            options: Object.keys(toyColor),
        });
        filterAttributes.push({
            name: 'Размер',
            attribute: 'size',
            filterType: filterBy.enumVal,
            options: Object.keys(toySize),
        });
        filterAttributes.push({
            name: 'Только любимые',
            attribute: 'favorite',
            filterType: filterBy.boolVal,
            value: false,
        });
